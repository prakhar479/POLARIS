...
async def demo_polaris_with_different_loggers():
    ...
    print("   python -m polaris.cli.main --config config/default.yaml --log-format human")
    print()
    ...
    print("   python -m polaris.cli.main --config config/default.yaml --log-level DEBUG --log-format human")
    print()
    print("4. Use structured logging with file export:")
    print("   python -m polaris.cli.main --config config/default.yaml --log-format structured --export-logs ./structured-export.log")
    print()
