...
class TestAdaptationAction:
    ...
    def test_adaptation_action_auto_id(self):
        ...
        action = AdaptationAction(
            action_id="", action_type="scale_up", target_system="test-system", parameters={}
        )
